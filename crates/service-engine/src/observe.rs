...
use crate::metrics::{
    ...
    MIRROR_RESTARTS_TOTAL, NOTIFICATION_QUEUE_USAGE, PASS_DELTAS, PASS_DURATION_SECONDS,
    PASS_IMPACTS, PASS_OVERFLOWS_TOTAL, PENDING_SESSIONS, RELAY_DRAINS_TOTAL, RELAY_ROWS_TOTAL,
    RESETS_TOTAL, SESSIONS, SESSIONS_ENDED_TOTAL, TRANSPORT_RECONNECTS_TOTAL,
};
...
pub fn record_dead_letter(source: &'static str) {
    metrics::counter!(
        DEAD_LETTERS_TOTAL,
