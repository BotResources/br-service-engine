...
#[tokio::test]
async fn s089_an_emitted_event_is_staged_in_the_write_tx_and_published_by_the_leader_relay() {
    ...
    let engine = boot_pipeline_engine(&db, fabric.clone(), "se_s089", "pod-s089").await;
