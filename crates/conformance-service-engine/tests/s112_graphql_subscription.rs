...
#[tokio::test]
async fn s112_a_subscription_resets_then_upserts_the_same_view_after_an_allowed_mutation() {
    ...
    let service = boot_graphql_service(&db, nats.nats().await, "se_s112", "pod-s112").await;
