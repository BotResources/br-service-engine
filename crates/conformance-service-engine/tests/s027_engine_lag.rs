...
const CHANNEL: &str = "se_s027_engine";
...
#[tokio::test]
async fn s027_engine_a_lagging_session_is_reset_to_last_sent_never_silently_ended() {
    ...
    let engine = spy_engine(
        &db,
        fabric,
        engine_config(CHANNEL, "pod-s027").with_session_buffer(BUFFER),
