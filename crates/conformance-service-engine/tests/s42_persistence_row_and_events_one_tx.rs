...
#[tokio::test]
async fn s42_a_failing_constraint_rolls_back_the_state_row_and_its_events_together() {
    ...
    let engine = boot_persistence_engine(&db, nats.nats().await, "se_s42", "pod-s42").await;
