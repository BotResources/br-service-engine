...
const CHANNEL: &str = "se_s054_engine";

#[tokio::test]
async fn s054_engine_the_note_slice_runs_end_to_end_with_the_assignment_slice_unregistered() {
    ...
    let mut engine = Engine::<SamplePrincipal>::boot(
        engine_config(CHANNEL, "pod-s054"),
        pool.clone(),
        fabric,
