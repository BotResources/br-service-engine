...
#[tokio::test]
async fn s45_an_integrity_violation_in_cx_save_is_terminal_whatever_the_handler_disposition_says() {
    ...
    let engine = boot_persistence_engine(&db, fabric.clone(), "se_s45", "pod-s45").await;
