...
#[tokio::test]
async fn s46_the_render_side_and_the_write_side_read_the_same_committed_full_eda_store() {
    ...
    let engine = boot_persistence_engine(&db, nats.nats().await, "se_s46", "pod-s46").await;
