...
#[tokio::test]
async fn s47_concurrent_commands_on_one_key_serialize_in_every_style_without_a_lost_update() {
    ...
    let engine = boot_serialization_engine(&db, nats.nats().await, "se_s47", "pod-s47").await;
