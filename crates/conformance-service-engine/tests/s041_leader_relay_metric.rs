...
#[tokio::test]
async fn s041_a_leader_relay_beat_reports_the_slot_it_won_and_the_slot_it_lost() {
...
#[tokio::test]
async fn s041_the_leader_slot_metric_counts_a_relay_win_not_only_a_cron_win() {
    ...
    let config = EngineConfig::new(
        ChannelName::from_static("se_s041_relay_metric"),
