...
const CHANNEL: &str = "se_s009_engine";

#[tokio::test]
async fn s009_engine_an_unassemblable_window_is_refused_and_the_running_engine_still_serves() {
    ...
    let mut engine = spy_engine(
        &db,
        fabric,
        engine_config(CHANNEL, "pod-s009"),
