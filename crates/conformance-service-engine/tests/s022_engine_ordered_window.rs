...
const CHANNEL: &str = "se_s022_engine";
const HEAD: i64 = 2;

#[tokio::test]
async fn s022_engine_a_key_that_sorts_into_the_head_is_upserted_and_pushes_one_out() {
    ...
    let engine = spy_engine(
        &db,
        fabric,
        engine_config(CHANNEL, "pod-s022").with_reset_threshold(2),
