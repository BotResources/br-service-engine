...
#[test]
fn s28_the_declared_gate_set_equals_the_rendered_affordance_surface() {
...
#[test]
fn s28_a_blocked_affordance_and_the_rejected_mutation_carry_the_same_reason_code() {
    let tenant = Uuid::now_v7();
    let principal = member_principal(tenant);
...
#[tokio::test]
async fn s28_engine_an_affordance_flip_on_a_state_change_reaches_the_session_as_an_upsert() {
    ...
    let engine = spy_engine(
        &db,
        fabric,
        engine_config("se_s28_flip", "pod-s28"),
