...
#[tokio::test]
async fn s100_a_unique_constraint_rejects_a_concurrent_duplicate_create_and_its_events_together() {
    ...
    let engine = boot_serialization_engine(&db, nats.nats().await, "se_s100", "pod-s100").await;
