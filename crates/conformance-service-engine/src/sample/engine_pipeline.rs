...
use crate::sample::pipeline::{
    ...
    RelabelWidget, ScheduleCreate, close_widget, create_widget, delete_widget, detonate_widget,
    import_widgets, lock_widget, mint_secret, relabel_widget, schedule_create,
};
